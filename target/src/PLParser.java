...
public class PLParser extends Parser {
		...
		try {
			...
			case 3:
				...
				case WORDQUOTE:
					{
					setState(164);
					((AssignmentContext)_localctx).WORDQUOTE = match(WORDQUOTE);
					 val = new StringLiteral(removeQuotes((((AssignmentContext)_localctx).WORDQUOTE!=null?((AssignmentContext)_localctx).WORDQUOTE.getText():null))); 
					}
					break;
				case NUMBER:
					{
					...
					((AssignmentContext)_localctx).NUMBER = match(NUMBER);
					 val = new IntLiteral((((AssignmentContext)_localctx).NUMBER!=null?((AssignmentContext)_localctx).NUMBER.getText():null)); 
					}
					break;
				default:
					throw new NoViableAltException(this);
				...
				case NUMBER:
					{
					setState(171);
					((AssignmentContext)_localctx).index = match(NUMBER);
					}
					break;
				case T__15:
					{
				...
				match(T__4);
				            ...
				            if(front == ""){
				                ((AssignmentContext)_localctx).expr =  new ListAddAt(toInt((((AssignmentContext)_localctx).index!=null?((AssignmentContext)_localctx).index.getText():null)), (((AssignmentContext)_localctx).name!=null?((AssignmentContext)_localctx).name.getText():null), val);
				            }
				            else if (front.equals("front")){
				                ((AssignmentContext)_localctx).expr =  new ListAddFrontBack(TRUEBOOLEAN, (((AssignmentContext)_localctx).name!=null?((AssignmentContext)_localctx).name.getText():null), val);
				            }
				            else{
				                ((AssignmentContext)_localctx).expr =  new ListAddFrontBack(FALSEBOOLEAN, (((AssignmentContext)_localctx).name!=null?((AssignmentContext)_localctx).name.getText():null), val);
				            }
	...
	public static final String _serializedATN =
		...
		"\u0001\u000b\u0001\u000b\u0001\u000b\u0001\u000b\u0001\u000b\u0001\u000b"+
		"\u0001\u000b\u0005\u000b\u0121\b\u000b\n\u000b\f\u000b\u0124\t\u000b\u0001"+
		"\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0005\f\u012d\b\f\n"+
		"\f\f\f\u0130\t\f\u0001\f\u0001\f\u0001\f\u0001\r\u0001\r\u0001\r\u0001"+
		"\r\u0001\r\u0001\r\u0001\r\u0005\r\u013c\b\r\n\r\f\r\u013f\t\r\u0001\r"+
		"\u0001\r\u0001\r\u0001\r\u0000\u0001\u0016\u000e\u0000\u0002\u0004\u0006"+
		"\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u0000\u0001\u0001\u0000"+
		"\u0014\u0015\u015d\u0000\u001c\u0001\u0000\u0000\u0000\u0002>\u0001\u0000"+
